...
export const FACTIONS: FactionEntry[] = [
  ...
  { nameEn: 'The Edyn Mandate', nameEs: 'El Mandato Edyn', iconPath: `${IMG_BASE}edyn.png`, shortName: 'Edyn' },
  { nameEn: 'The Florzen Profiteers', nameEs: 'The Florzen Profiteers', iconPath: `${IMG_BASE}florzen.png`, shortName: 'Florzen' },
  { nameEn: 'The Free Systems Compact', nameEs: 'La Alianza de Sistemas Libres', iconPath: `${IMG_BASE}fsc.png`, shortName: 'Free Systems' },
  ...
  { nameEn: 'The Berserkers of Kjalengard', nameEs: 'Los Berserkers de Kjalengard', iconPath: `${IMG_BASE}Berserkers.png`, shortName: 'Kjalengard' },
